...
helpFunction()
{
    ...
    echo -e "\t-s start number of simulation of MS"
    echo -e "\t-e end number of simulations of MS"
    echo -e "\t-b start number of simulation of MSSEL"
    echo -e "\t-f end number of simulations of MSSEL"
    echo -e "\t-i number of populations per MS/MSSEL file/simulation"
...
while getopts "hs:e:b:f:i:c:d:" flag
do
    case "${flag}" in
        s) startBASE=${OPTARG};;
        e) endBASE=${OPTARG};;
...
if [ -z "$startBASE" ] || [ -z "$endBASE" ] || [ -z "$startTEST" ] || [ -z "$endTEST" ] || [ -z "$numberOfPopulations" ] || [ -z "$individuals" ] || [ -z "$directory" ]
then
    echo "Some or all of the parameters are empty";
    helpFunction
fi

echo "startBASE BASE: $startBASE";
echo "endBASE BASE: $endBASE";
echo "startBASE TEST: $startTEST";
echo "endBASE TEST: $endTEST";
...
## MSSEL files ##
#################
echo starting with mssel
################################################################################################################################################################
if [[ $startTEST -le 1 && $endTEST -ge 1 ]]
then
    echo "run TEST 1";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory1.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 > $directory/raw/selection/TEST1.txt &
fi
if [[ $startTEST -le 2 && $endTEST -ge 2 ]]
then
    echo "run TEST 2";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory2.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10100000000000000000 1 > $directory/raw/selection/TEST2.txt &
fi
if [[ $startTEST -le 3 && $endTEST -ge 3 ]]
then
    echo "run TEST 3";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory3.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10200000000000000000 1 > $directory/raw/selection/TEST3.txt &
fi
if [[ $startTEST -le 4 && $endTEST -ge 4 ]]
then
    echo "run TEST 4";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory4.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.1 -eN .10040000000000000000 1 > $directory/raw/selection/TEST4.txt &
fi
if [[ $startTEST -le 5 && $endTEST -ge 5 ]]
then
    echo "run TEST 5";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory5.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.1 -eN .10100000000000000000 1 > $directory/raw/selection/TEST5.txt &
fi
if [[ $startTEST -le 6 && $endTEST -ge 6 ]]
then
    echo "run TEST 6";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory6.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.1 -eN .10200000000000000000 1 > $directory/raw/selection/TEST6.txt &
fi
wait
if [[ $startTEST -le 7 && $endTEST -ge 7 ]]
then
    echo "run TEST 7";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory7.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.01 -eN .10040000000000000000 1 > $directory/raw/selection/TEST7.txt &
fi
if [[ $startTEST -le 8 && $endTEST -ge 8 ]]
then
    echo "run TEST 8";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory8.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.01 -eN .10100000000000000000 1 > $directory/raw/selection/TEST8.txt &
fi
if [[ $startTEST -le 9 && $endTEST -ge 9 ]]
then
    echo "run TEST 9";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory9.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.01 -eN .10200000000000000000 1 > $directory/raw/selection/TEST9.txt &
fi
if [[ $startTEST -le 10 && $endTEST -ge 10 ]]
then
    echo "run TEST 10";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory10.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.005 -eN .10040000000000000000 1 > $directory/raw/selection/TEST10.txt & 
fi
if [[ $startTEST -le 11 && $endTEST -ge 11 ]]
then
    echo "run TEST 11";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory11.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.005 -eN .10100000000000000000 1 > $directory/raw/selection/TEST11.txt &
fi
if [[ $startTEST -le 12 && $endTEST -ge 12 ]]
then
    echo "run TEST 12";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory12.txt 1000 -t 2000 -r 2000 2000 -eN .10000000000000000000 0.005 -eN .10200000000000000000 1 > $directory/raw/selection/TEST12.txt &
fi
wait
if [[ $startTEST -le 13 && $endTEST -ge 13 ]]
then
    echo "run TEST 13";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory13.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.5 -eN .02040000000000000000 1 > $directory/raw/selection/TEST13.txt & 
fi
if [[ $startTEST -le 14 && $endTEST -ge 14 ]]
then
    echo "run TEST 14";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory14.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.5 -eN .02100000000000000000 1 > $directory/raw/selection/TEST14.txt &
fi
if [[ $startTEST -le 15 && $endTEST -ge 15 ]]
then
    echo "run TEST 15";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory15.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.5 -eN .02200000000000000000 1 > $directory/raw/selection/TEST15.txt &
fi
if [[ $startTEST -le 16 && $endTEST -ge 16 ]]
then
    echo "run TEST 16";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory16.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.1 -eN .02040000000000000000 1 > $directory/raw/selection/TEST16.txt &
fi
if [[ $startTEST -le 17 && $endTEST -ge 17 ]]
then
    echo "run TEST 17";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory17.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.1 -eN .02100000000000000000 1 > $directory/raw/selection/TEST17.txt &
fi
if [[ $startTEST -le 18 && $endTEST -ge 18 ]]
then
    echo "run TEST 18";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory18.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.1 -eN .02200000000000000000 1 > $directory/raw/selection/TEST18.txt &
fi
wait
if [[ $startTEST -le 19 && $endTEST -ge 19 ]]
then
    echo "run TEST 19";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory19.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.01 -eN .02040000000000000000 1 > $directory/raw/selection/TEST19.txt &
fi
if [[ $startTEST -le 20 && $endTEST -ge 20 ]]
then
    echo "run TEST 20";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory20.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.01 -eN .02100000000000000000 1 > $directory/raw/selection/TEST20.txt &
fi
if [[ $startTEST -le 21 && $endTEST -ge 21 ]]
then
    echo "run TEST 21";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory21.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.01 -eN .02200000000000000000 1 > $directory/raw/selection/TEST21.txt &
fi
if [[ $startTEST -le 22 && $endTEST -ge 22 ]]
then
    echo "run TEST 22";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory22.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.005 -eN .02040000000000000000 1 > $directory/raw/selection/TEST22.txt &
fi
if [[ $startTEST -le 23 && $endTEST -ge 23 ]]
then
    echo "run TEST 23";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory23.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.005 -eN .02100000000000000000 1 > $directory/raw/selection/TEST23.txt &
fi
if [[ $startTEST -le 24 && $endTEST -ge 24 ]]
then
    echo "run TEST 24";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory24.txt 1000 -t 2000 -r 2000 2000 -eN .02000000000000000000 0.005 -eN .02200000000000000000 1 > $directory/raw/selection/TEST24.txt &
fi
wait
if [[ $startTEST -le 25 && $endTEST -ge 25 ]]
then
    echo "run TEST 25";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory25.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.5 -eN .01540000000000000000 1 > $directory/raw/selection/TEST25.txt &
fi
if [[ $startTEST -le 26 && $endTEST -ge 26 ]]
then
    echo "run TEST 26";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory26.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.5 -eN .01600000000000000000 1 > $directory/raw/selection/TEST26.txt &
fi
if [[ $startTEST -le 27 && $endTEST -ge 27 ]]
then
    echo "run TEST 27";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory27.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.5 -eN .01700000000000000000 1 > $directory/raw/selection/TEST27.txt &
fi
if [[ $startTEST -le 28 && $endTEST -ge 28 ]]
then
    echo "run TEST 28";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory28.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.1 -eN .01540000000000000000 1 > $directory/raw/selection/TEST28.txt &
fi
if [[ $startTEST -le 29 && $endTEST -ge 29 ]]
then
    echo "run TEST 29";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory29.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.1 -eN .01600000000000000000 1 > $directory/raw/selection/TEST29.txt &
fi
if [[ $startTEST -le 30 && $endTEST -ge 30 ]]
then
    echo "run TEST 30";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory30.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.1 -eN .01700000000000000000 1 > $directory/raw/selection/TEST30.txt &
fi
wait
if [[ $startTEST -le 31 && $endTEST -ge 31 ]]
then
    echo "run TEST 31";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory31.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.01 -eN .01540000000000000000 1 > $directory/raw/selection/TEST31.txt &
fi
if [[ $startTEST -le 32 && $endTEST -ge 32 ]]
then
    echo "run TEST 32";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory32.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.01 -eN .01600000000000000000 1 > $directory/raw/selection/TEST32.txt &
fi
if [[ $startTEST -le 33 && $endTEST -ge 33 ]]
then
    echo "run TEST 33";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory33.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.01 -eN .01700000000000000000 1 > $directory/raw/selection/TEST33.txt &
fi
if [[ $startTEST -le 34 && $endTEST -ge 34 ]]
then
    echo "run TEST 34";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory34.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.005 -eN .01540000000000000000 1 > $directory/raw/selection/TEST34.txt &
fi
if [[ $startTEST -le 35 && $endTEST -ge 35 ]]
then
    echo "run TEST 35";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory35.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.005 -eN .01600000000000000000 1 > $directory/raw/selection/TEST35.txt &
fi
if [[ $startTEST -le 36 && $endTEST -ge 36 ]]
then
    echo "run TEST 36";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory36.txt 1000 -t 2000 -r 2000 2000 -eN .01500000000000000000 0.005 -eN .01700000000000000000 1 > $directory/raw/selection/TEST36.txt &
fi
wait
if [[ $startTEST -le 37 && $endTEST -ge 37 ]]
then
    echo "run TEST 37";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory37.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.5 -eN .01040000000000000000 1 > $directory/raw/selection/TEST37.txt &
fi
if [[ $startTEST -le 38 && $endTEST -ge 38 ]]
then
    echo "run TEST 38";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory38.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.5 -eN .01100000000000000000 1 > $directory/raw/selection/TEST38.txt &
fi
if [[ $startTEST -le 39 && $endTEST -ge 39 ]]
then
    echo "run TEST 39";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory39.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.5 -eN .01200000000000000000 1 > $directory/raw/selection/TEST39.txt &
fi
if [[ $startTEST -le 40 && $endTEST -ge 40 ]]
then
    echo "run TEST 40";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory40.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.1 -eN .01040000000000000000 1 > $directory/raw/selection/TEST40.txt &
fi
if [[ $startTEST -le 41 && $endTEST -ge 41 ]]
then
    echo "run TEST 41";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory41.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.1 -eN .01100000000000000000 1 > $directory/raw/selection/TEST41.txt &
fi
if [[ $startTEST -le 42 && $endTEST -ge 42 ]]
then
    echo "run TEST 42";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory42.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.1 -eN .01200000000000000000 1 > $directory/raw/selection/TEST42.txt &
fi
wait
if [[ $startTEST -le 43 && $endTEST -ge 43 ]]
then
    echo "run TEST 43";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory43.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.01 -eN .01040000000000000000 1 > $directory/raw/selection/TEST43.txt &
fi
if [[ $startTEST -le 44 && $endTEST -ge 44 ]]
then
    echo "run TEST 44";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory44.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.01 -eN .01100000000000000000 1 > $directory/raw/selection/TEST44.txt &
fi
if [[ $startTEST -le 45 && $endTEST -ge 45 ]]
then
    echo "run TEST 45";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory45.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.01 -eN .01200000000000000000 1 > $directory/raw/selection/TEST45.txt &
fi
if [[ $startTEST -le 46 && $endTEST -ge 46 ]]
then
    echo "run TEST 46";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory46.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.005 -eN .01040000000000000000 1 > $directory/raw/selection/TEST46.txt &
fi
if [[ $startTEST -le 47 && $endTEST -ge 47 ]]
then
    echo "run TEST 47";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory47.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.005 -eN .01100000000000000000 1 > $directory/raw/selection/TEST47.txt &
fi
if [[ $startTEST -le 48 && $endTEST -ge 48 ]]
then
    echo "run TEST 48";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory48.txt 1000 -t 2000 -r 2000 2000 -eN .01000000000000000000 0.005 -eN .01200000000000000000 1 > $directory/raw/selection/TEST48.txt &
fi
wait
if [[ $startTEST -le 49 && $endTEST -ge 49 ]]
then
    echo "run TEST 49";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory49.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.5 -eN .00440000000000000000 1 > $directory/raw/selection/TEST49.txt  &
fi
if [[ $startTEST -le 50 && $endTEST -ge 50 ]]
then
    echo "run TEST 50";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory50.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.5 -eN .00500000000000000000 1 > $directory/raw/selection/TEST50.txt  &
fi
if [[ $startTEST -le 51 && $endTEST -ge 51 ]]
then
    echo "run TEST 51";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory51.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.5 -eN .00600000000000000000 1 > $directory/raw/selection/TEST51.txt  &
fi
if [[ $startTEST -le 52 && $endTEST -ge 52 ]]
then
    echo "run TEST 52";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory52.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.1 -eN .00440000000000000000 1 > $directory/raw/selection/TEST52.txt &
fi
if [[ $startTEST -le 53 && $endTEST -ge 53 ]]
then
    echo "run TEST 53";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory53.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.1 -eN .00500000000000000000 1 > $directory/raw/selection/TEST53.txt &
fi
if [[ $startTEST -le 54 && $endTEST -ge 54 ]]
then
    echo "run TEST 54";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory54.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.1 -eN .00600000000000000000 1 > $directory/raw/selection/TEST54.txt &
fi
wait
if [[ $startTEST -le 55 && $endTEST -ge 55 ]]
then
    echo "run TEST 55";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory55.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.01 -eN .00440000000000000000 1 > $directory/raw/selection/TEST55.txt &
fi
if [[ $startTEST -le 56 && $endTEST -ge 56 ]]
then
    echo "run TEST 56";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory56.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.01 -eN .00500000000000000000 1 > $directory/raw/selection/TEST56.txt &
fi
if [[ $startTEST -le 57 && $endTEST -ge 57 ]]
then
    echo "run TEST 57";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory57.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.01 -eN .00600000000000000000 1 > $directory/raw/selection/TEST57.txt &
fi
if [[ $startTEST -le 58 && $endTEST -ge 58 ]]
then
    echo "run TEST 58";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory58.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.005 -eN .00440000000000000000 1 > $directory/raw/selection/TEST58.txt &
fi
if [[ $startTEST -le 59 && $endTEST -ge 59 ]]
then
    echo "run TEST 59";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory59.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.005 -eN .00500000000000000000 1 > $directory/raw/selection/TEST59.txt &
fi
if [[ $startTEST -le 60 && $endTEST -ge 60 ]]
then
    echo "run TEST 60";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory60.txt 1000 -t 2000 -r 2000 2000 -eN .00400000000000000000 0.005 -eN .00600000000000000000 1 > $directory/raw/selection/TEST60.txt &
fi
wait
if [[ $startTEST -le 61 && $endTEST -ge 61 ]]
then
    echo "run TEST 61";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 0.003 1 2 -en 0.003 2 1 > $directory/raw/selection/TEST61.txt &
fi
if [[ $startTEST -le 62 && $endTEST -ge 62 ]]
then
    echo "run TEST 62";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 0.005 1 2 -en 0.005 2 1 > $directory/raw/selection/TEST62.txt &
fi
if [[ $startTEST -le 63 && $endTEST -ge 63 ]]
then
    echo "run TEST 63";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 0.01 1 2 -en 0.01 2 1 > $directory/raw/selection/TEST63.txt &
fi
if [[ $startTEST -le 64 && $endTEST -ge 64 ]]
then
    echo "run TEST 64";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 0.05 1 2 -en 0.05 2 1 > $directory/raw/selection/TEST64.txt &
fi
if [[ $startTEST -le 65 && $endTEST -ge 65 ]]
then
    echo "run TEST 65";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 0.1 1 2 -en 0.1 2 1 > $directory/raw/selection/TEST65.txt &
fi
if [[ $startTEST -le 66 && $endTEST -ge 66 ]]
then
    echo "run TEST 66";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 0.5 1 2 -en 0.5 2 1 > $directory/raw/selection/TEST66.txt &
fi
wait
if [[ $startTEST -le 67 && $endTEST -ge 67 ]]
then
    echo "run TEST 67";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 1 1 2 -en 1 2 1 > $directory/raw/selection/TEST67.txt &
fi
if [[ $startTEST -le 68 && $endTEST -ge 68 ]]
then
    echo "run TEST 68";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 1.5 1 2 -en 1.5 2 1 > $directory/raw/selection/TEST68.txt &
fi
if [[ $startTEST -le 69 && $endTEST -ge 69 ]]
then
    echo "run TEST 69";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 2 1 2 -en 2 2 1 > $directory/raw/selection/TEST69.txt &
fi
if [[ $startTEST -le 70 && $endTEST -ge 70 ]]
then
    echo "run TEST 70";
    ./msseldir/mssel $individuals $numberOfPopulations 0 $individuals ./trajectory_files/trajectory_continent_island.txt 1000 -I 2 0 0 0 20 0.0 -en 0 2 0.05 -em 0 2 1 3 -t 2000 -r 2000 2000 -ej 3 1 2 -en 3 2 1 > $directory/raw/selection/TEST70.txt &
fi
if [[ $startTEST -le 71 && $endTEST -ge 71 ]]
then
    echo "run TEST 71";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 950 1050 2 > $directory/raw/selection/TEST71.txt &
fi
if [[ $startTEST -le 72 && $endTEST -ge 72 ]]
then
    echo "run TEST 72";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 950 1050 4 > $directory/raw/selection/TEST72.txt &
fi
wait
if [[ $startTEST -le 73 && $endTEST -ge 73 ]]
then
    echo "run TEST 73";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 950 1050 8 > $directory/raw/selection/TEST73.txt &
fi
if [[ $startTEST -le 74 && $endTEST -ge 74 ]]
then
    echo "run TEST 74";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 950 1050 10 > $directory/raw/selection/TEST74.txt &
fi
if [[ $startTEST -le 75 && $endTEST -ge 75 ]]
then
    echo "run TEST 75";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 950 1050 20 > $directory/raw/selection/TEST75.txt &
fi
if [[ $startTEST -le 76 && $endTEST -ge 76 ]]
then
    echo "run TEST 76";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 950 1050 40 > $directory/raw/selection/TEST76.txt &
fi
if [[ $startTEST -le 77 && $endTEST -ge 77 ]]
then
    echo "run TEST 77";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 950 1050 100 > $directory/raw/selection/TEST77.txt &
fi
if [[ $startTEST -le 78 && $endTEST -ge 78 ]]
then
    echo "run TEST 78";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 900 1100 2 > $directory/raw/selection/TEST78.txt &
fi
wait
if [[ $startTEST -le 79 && $endTEST -ge 79 ]]
then
    echo "run TEST 79";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 900 1100 4 > $directory/raw/selection/TEST79.txt &
fi
if [[ $startTEST -le 80 && $endTEST -ge 80 ]]
then
    echo "run TEST 80";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 900 1100 8 > $directory/raw/selection/TEST80.txt &
fi
if [[ $startTEST -le 81 && $endTEST -ge 81 ]]
then
    echo "run TEST 81";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 900 1100 10 > $directory/raw/selection/TEST81.txt &
fi
if [[ $startTEST -le 82 && $endTEST -ge 82 ]]
then
    echo "run TEST 82";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 900 1100 20 > $directory/raw/selection/TEST82.txt &
fi
if [[ $startTEST -le 83 && $endTEST -ge 83 ]]
then
    echo "run TEST 83";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 900 1100 40 > $directory/raw/selection/TEST83.txt &
fi
if [[ $startTEST -le 84 && $endTEST -ge 84 ]]
then
    echo "run TEST 84";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 1 900 1100 100 > $directory/raw/selection/TEST84.txt &
fi
wait
if [[ $startTEST -le 85 && $endTEST -ge 85 ]]
then
    echo "run TEST 85";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 3 450 550 2 950 1050 2 1450 1550 2 > $directory/raw/selection/TEST85.txt &
fi
if [[ $startTEST -le 86 && $endTEST -ge 86 ]]
then
    echo "run TEST 86";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 3 450 550 4 950 1050 4 1450 1550 4 > $directory/raw/selection/TEST86.txt &
fi
if [[ $startTEST -le 87 && $endTEST -ge 87 ]]
then
    echo "run TEST 87";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 3 450 550 8 950 1050 8 1450 1550 8 > $directory/raw/selection/TEST87.txt &
fi
if [[ $startTEST -le 88 && $endTEST -ge 88 ]]
then
    echo "run TEST 88";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 3 450 550 10 950 1050 10 1450 1550 10 > $directory/raw/selection/TEST88.txt &
fi
if [[ $startTEST -le 89 && $endTEST -ge 89 ]]
then
    echo "run TEST 89";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 3 450 550 20 950 1050 20 1450 1550 20 > $directory/raw/selection/TEST89.txt &
fi
if [[ $startTEST -le 90 && $endTEST -ge 90 ]]
then
    echo "run TEST 90";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 3 450 550 40 950 1050 40 1450 1550 40 > $directory/raw/selection/TEST90.txt &
fi
wait
if [[ $startTEST -le 91 && $endTEST -ge 91 ]]
then
    echo "run TEST 91";
    ./msHOT/msHOT $individuals $numberOfPopulations -t 2000 -r 2000 2000 -eN .10000000000000000000 0.5 -eN .10040000000000000000 1 -v 3 450 550 100 950 1050 100 1450 1550 100 > $directory/raw/selection/TEST91.txt &
fi
if [[ $startTEST -le 92 && $endTEST -ge 92 ]]
then
    echo "run TEST 92";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 50000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_2.txt > $directory/raw/selection/TEST92.txt &
fi
if [[ $startTEST -le 93 && $endTEST -ge 93 ]]
then
    echo "run TEST 93";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 50000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_4.txt > $directory/raw/selection/TEST93.txt &
fi
if [[ $startTEST -le 94 && $endTEST -ge 94 ]]
then
    echo "run TEST 94";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 50000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_8.txt > $directory/raw/selection/TEST94.txt &
fi
if [[ $startTEST -le 95 && $endTEST -ge 95 ]]
then
    echo "run TEST 95";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 50000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_10.txt > $directory/raw/selection/TEST95.txt &
fi
if [[ $startTEST -le 96 && $endTEST -ge 96 ]]
then
    echo "run TEST 96";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 50000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_20.txt > $directory/raw/selection/TEST96.txt &
fi
if [[ $startTEST -le 97 && $endTEST -ge 97 ]]
then
    echo "run TEST 97";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 30000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_2.txt > $directory/raw/selection/TEST97.txt &
fi
if [[ $startTEST -le 98 && $endTEST -ge 98 ]]
then
    echo "run TEST 98";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 30000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_4.txt > $directory/raw/selection/TEST98.txt &
fi
if [[ $startTEST -le 99 && $endTEST -ge 99 ]]
then
    echo "run TEST 99";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 30000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_8.txt > $directory/raw/selection/TEST99.txt &
fi
if [[ $startTEST -le 100 && $endTEST -ge 100 ]]
then
    echo "run TEST 100";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 30000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_10.txt > $directory/raw/selection/TEST100.txt &
fi
if [[ $startTEST -le 101 && $endTEST -ge 101 ]]
then
    echo "run TEST 101";
    ./mbs/mbs $individuals -t 0.02 -r 0.02 -s 100000 30000 -f 1 $numberOfPopulations ./mbsFiles/traj -h ./mbsFiles/rechot_47500_52500_20.txt > $directory/raw/selection/TEST101.txt &
fi
################################################################################################################################################################
wait
echo succesfully generated all raw files with the tools MS and MSSEL
